...
const Profile = () => {
  return (
    <aside className='max-w-3xl border m-6 border-neutral-600 bg-neutral-900 text-white p-6 rounded-lg lg:sticky lg:right-0 lg:top-6 lg:w-96'>
      <div className='flex flex-col gap-4'>
        <div className='flex items-center justify-between gap-x-10'>
          <h1 className='text-3xl font-bold'>David</h1>
          <p className='text-sm'>Forward Deployed Engineer</p>
        </div>
        ...
        <div className='mt-6'>
          ...
          <p className='text-lg capitalize'>10x engineering</p>
        </div>

        <div>
          <p className='text-sm text-neutral-300'>Based in:</p>
          <p className='text-lg capitalize'>The matrix</p>
        </div>
